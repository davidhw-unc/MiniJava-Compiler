...
public final class Machine {
     ...
     */
    public enum Prim {
        id, not, and, or, succ, pred, neg, add, sub, mult, div, mod, lt, le, ge, gt, eq, ne, eol,
        eof, get, put, geteol, puteol, getint, putint, putintnl, alloc, dispose, newobj, newarr,
        arraylen, arrayref, arrayupd, fieldref, fieldupd;
    }
    ...
    private static void emit(int op, int n, int r, int d) {
        ...
        if (CT >= Machine.PB) System.out.println("mJAM: code segment capacity exceeded");
